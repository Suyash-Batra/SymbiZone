...
<div id="profile" class="dropdown">
  ...
  <div class="dropdown-content">
    ...
    <div class="headings">Laptops</div>
    <div class="center">
      <hr width="1300px" />
    </div>
    <br />
    ...
    <div class="container">
      <?php
$allowedIds = array(3, 9, 11, 20); // Define an array of allowed product IDs

while ($row = mysqli_fetch_assoc($result)) {
    if (in_array($row['id'], $allowedIds)) { // Check if the product ID is in the allowed list
        component($row['pname'], $row['price'], $row['image'], $row['descr'], $row['link'], $row['id']);
    }
}
    ...
    <footer>
      ...
      <div id="mode">
        <a href="light mode/products/laptop.php"
