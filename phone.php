...
<div id="profile" class="dropdown">
  ...
  <div class="dropdown-content">
    ...
    <div class="container">
      <?php
      $allowedIds = array(7, 17, 13, 12); // Define an array of allowed product IDs

while ($row = mysqli_fetch_assoc($result)) {
    if (in_array($row['id'], $allowedIds)) { // Check if the product ID is in the allowed list
        component($row['pname'], $row['price'], $row['image'], $row['descr'], $row['link']);
    }
}
    ...
    <footer>
      ...
      <div id="mode">
        <a href="light mode/products/phone.php"
